...
<style id="custom-css" type="text/css">:root {--primary-color: #1a676a;}.container-width, .full-width .ubermenu-nav, .container, .row{max-width: 1250px}.row.row-collapse{max-width: 1220px}.row.row-small{max-width: 1242.5px}.row.row-large{max-width: 1280px}.header-main{height: 136px}#logo img{max-height: 136px}#logo{width:200px;}#logo img{padding:9px 0;}.header-bottom{min-height: 10px}.header-top{min-height: 43px}.transparent .header-main{height: 30px}.transparent #logo img{max-height: 30px}.has-transparent + .page-title:first-of-type,.has-transparent + #main > .page-title,.has-transparent + #main > div > .page-title,.has-transparent + #main .page-header-wrapper:first-of-type .page-title{padding-top: 60px;}.header.show-on-scroll,.stuck .header-main{height:70px!important}.stuck #logo img{max-height: 70px!important}.header-bg-color {background-color: rgba(255,255,255,0.9)}.header-bottom {background-color: #f1f1f1}.header-main .nav > li > a{line-height: 16px }.stuck .header-main .nav > li > a{line-height: 50px }@media (max-width: 549px) {.header-main{height: 70px}#logo img{max-height: 70px}}/* Color */.accordion-title.active, .has-icon-bg .icon .icon-inner,.logo a, .primary.is-underline, .primary.is-link, .badge-outline .badge-inner, .nav-outline > li.active> a,.nav-outline >li.active > a, .cart-icon strong,[data-color='primary'], .is-outline.primary{color: #1a676a;}/* Color !important */[data-text-color="primary"]{color: #1a676a!important;}/* Background Color */[data-text-bg="primary"]{background-color: #1a676a;}/* Background */.scroll-to-bullets a,.featured-title, .label-new.menu-item > a:after, .nav-pagination > li > .current,.nav-pagination > li > span:hover,.nav-pagination > li > a:hover,.has-hover:hover .badge-outline .badge-inner,button[type="submit"], .button.wc-forward:not(.checkout):not(.checkout-button), .button.submit-button, .button.primary:not(.is-outline),.featured-table .title,.is-outline:hover, .has-icon:hover .icon-label,.nav-dropdown-bold .nav-column li > a:hover, .nav-dropdown.nav-dropdown-bold > li > a:hover, .nav-dropdown-bold.dark .nav-column li > a:hover, .nav-dropdown.nav-dropdown-bold.dark > li > a:hover, .header-vertical-menu__opener ,.is-outline:hover, .tagcloud a:hover,.grid-tools a, input[type='submit']:not(.is-form), .box-badge:hover .box-text, input.button.alt,.nav-box > li > a:hover,.nav-box > li.active > a,.nav-pills > li.active > a ,.current-dropdown .cart-icon strong, .cart-icon:hover strong, .nav-line-bottom > li > a:before, .nav-line-grow > li > a:before, .nav-line > li > a:before,.banner, .header-top, .slider-nav-circle .flickity-prev-next-button:hover svg, .slider-nav-circle .flickity-prev-next-button:hover .arrow, .primary.is-outline:hover, .button.primary:not(.is-outline), input[type='submit'].primary, input[type='submit'].primary, input[type='reset'].button, input[type='button'].primary, .badge-inner{background-color: #1a676a;}/* Border */.nav-vertical.nav-tabs > li.active > a,.scroll-to-bullets a.active,.nav-pagination > li > .current,.nav-pagination > li > span:hover,.nav-pagination > li > a:hover,.has-hover:hover .badge-outline .badge-inner,.accordion-title.active,.featured-table,.is-outline:hover, .tagcloud a:hover,blockquote, .has-border, .cart-icon strong:after,.cart-icon strong,.blockUI:before, .processing:before,.loading-spin, .slider-nav-circle .flickity-prev-next-button:hover svg, .slider-nav-circle .flickity-prev-next-button:hover .arrow, .primary.is-outline:hover{border-color: #1a676a}.nav-tabs > li.active > a{border-top-color: #1a676a}.widget_shopping_cart_content .blockUI.blockOverlay:before { border-left-color: #1a676a }.woocommerce-checkout-review-order .blockUI.blockOverlay:before { border-left-color: #1a676a }/* Fill */.slider .flickity-prev-next-button:hover svg,.slider .flickity-prev-next-button:hover .arrow{fill: #1a676a;}/* Background Color */[data-icon-label]:after, .secondary.is-underline:hover,.secondary.is-outline:hover,.icon-label,.button.secondary:not(.is-outline),.button.alt:not(.is-outline), .badge-inner.on-sale, .button.checkout, .single_add_to_cart_button, .current .breadcrumb-step{ background-color:#303030; }[data-text-bg="secondary"]{background-color: #303030;}/* Color */.secondary.is-underline,.secondary.is-link, .secondary.is-outline,.stars a.active, .star-rating:before, .woocommerce-page .star-rating:before,.star-rating span:before, .color-secondary{color: #303030}/* Color !important */[data-text-color="secondary"]{color: #303030!important;}/* Border */.secondary.is-outline:hover{border-color:#303030}.success.is-underline:hover,.success.is-outline:hover,.success{background-color: #bdf003}.success-color, .success.is-link, .success.is-outline{color: #bdf003;}.success-border{border-color: #bdf003!important;}/* Color !important */[data-text-color="success"]{color: #bdf003!important;}/* Background Color */[data-text-bg="success"]{background-color: #bdf003;}.alert.is-underline:hover,.alert.is-outline:hover,.alert{background-color: #6b2720}.alert.is-link, .alert.is-outline, .color-alert{color: #6b2720;}/* Color !important */[data-text-color="alert"]{color: #6b2720!important;}/* Background Color */[data-text-bg="alert"]{background-color: #6b2720;}body{font-size: 100%;}body{font-family:"Lato", sans-serif}body{font-weight: 400}.nav > li > a {font-family:"Lato", sans-serif;}.mobile-sidebar-levels-2 .nav > li > ul > li > a {font-family:"Lato", sans-serif;}.nav > li > a {font-weight: 700;}.mobile-sidebar-levels-2 .nav > li > ul > li > a {font-weight: 700;}h1,h2,h3,h4,h5,h6,.heading-font, .off-canvas-center .nav-sidebar.nav-vertical > li > a{font-family: "Lato", sans-serif;}h1,h2,h3,h4,h5,h6,.heading-font,.banner h1,.banner h2{font-weight: 700;}h1,h2,h3,h4,h5,h6,.heading-font{color: #303030;}.alt-font{font-family: "Dancing Script", sans-serif;}.alt-font{font-weight: 400!important;}a{color: #1a676a;}a:hover{color: #303030;}.tagcloud a:hover{border-color: #303030;background-color: #303030;}.widget a{color: #1a676a;}.widget a:hover{color: #303030;}.widget .tagcloud a:hover{border-color: #303030; background-color: #303030;}.footer-1{background-color: #303030}.footer-2{background-color: #333333}.absolute-footer, html{background-color: #1e1e1e}/* Custom CSS */#wrapper, #main {background-color: #EFEFEF;}.widget {margin-bottom: 1.5em;font-size: 13px;}.label-new.menu-item > a:after{content:"New";}.label-hot.menu-item > a:after{content:"Hot";}.label-sale.menu-item > a:after{content:"Sale";}.label-popular.menu-item > a:after{content:"Popular";}</style></head>

<body class="home page-template-default page page-id-2 full-width lightbox nav-dropdown-has-arrow nav-dropdown-has-shadow nav-dropdown-has-border elementor-default elementor-kit-41 elementor-page elementor-page-2">
      ...
      <div class="flex-col hide-for-medium flex-right">
         <ul class="nav top-bar-nav nav-right nav-small  nav-divided nav-uppercase">
          ...
          <ul class="nav nav-center nav-small mobile-nav  nav-divided nav-uppercase">
              <li class="html custom html_topbar_left"><strong class="uppercase">expertos en la integración de Soluciones de Tecnologías de la información</strong></li>          </ul>
      </div>
		...
		<img width="820" height="1000" src="{{asset('images/veriopoint.png')}}" class="header_logo header-logo" alt="Veriopoint"/><img  width="820" height="996" src="{{asset('images/veriopoint.png')}}" class="header-logo-dark" alt="Veriopoint"/></a>
          ...
          <div class="flex-col hide-for-medium flex-right">
            <ul class="header-nav header-nav-main nav nav-right  nav-divided nav-uppercase">
              <li id="menu-item-16" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-16 menu-item-design-default"><a href="#nosotros" class="nav-top-link">Nosotros</a></li>
		...
		<div class="large-12 col">
			<div class="col-inner">
								...
								<div data-elementor-type="wp-page" data-elementor-id="2" class="elementor elementor-2">
									<section class="elementor-section elementor-top-section elementor-element elementor-element-6e0275b elementor-section-full_width elementor-section-content-top elementor-section-height-default elementor-section-height-default" data-id="6e0275b" data-element_type="section">
						<div class="elementor-container elementor-column-gap-no">
					<div class="elementor-column elementor-col-100 elementor-top-column elementor-element elementor-element-ff1a8e8" data-id="ff1a8e8" data-element_type="column">
			<div class="elementor-widget-wrap elementor-element-populated">
								<div class="elementor-element elementor-element-ecf0cf7 elementor-widget elementor-widget-slider_revolution" data-id="ecf0cf7" data-element_type="widget" data-widget_type="slider_revolution.default">
				<div class="elementor-widget-container">
			
		<div class="wp-block-themepunch-revslider">
			<!-- START Prinicipal REVOLUTION SLIDER 6.5.19 --><p class="rs-p-wp-fix"></p>
...
<!--
							...
							--><rs-layer
								...
								data-type="button"
								data-rsp_ch="on"
								data-xy="x:l,l,l,c;xo:580px,580px,580px,0;yo:700px,700px,700px,527px;"
								...
								data-frame_1="x:0,0,0,0px;y:0,0,0,0px;e:power2.out;st:2540;sp:1000;sR:2540;"
								data-frame_1_mask="u:t;x:0,0,0,0px;y:0,0,0,0px;"
								data-frame_999="o:0;st:w;sR:5460;"
								data-frame_hover="c:#ff3a2d;bgc:rgba(0,0,0,0);boc:#ff3a2d;bor:16px,16px,16px,16px;bos:solid;bow:1px,1px,1px,1px;"
								style="z-index:9;background-color:rgba(255,255,255,0);font-family:'Roboto';"
							>Conócenos <i class="fa-arrow-down"></i> 
							</rs-layer><!--
							...
							--><rs-layer
								...
								data-frame_0="x:0,0,0,0px;y:0,0,0,0px;"
								data-frame_1="x:0,0,0,0px;y:0,0,0,0px;e:power4.inOut;st:1690;sp:1200;sR:1690;"
							...
							>Integration 
								...
								data-color="#fff"
								data-rsp_ch="on"
								data-xy="x:l,l,l,c;xo:92px,92px,92px,0;yo:480px,480px,480px,327px;"
								data-text="w:normal;s:76,76,76,50;l:93,93,93,63;fw:900;"
								data-dim="minh:0,0,0,none;"
								data-frame_0="x:0,0,0,0px;y:0,0,0,0px;"
								data-frame_1="x:0,0,0,0px;y:0,0,0,0px;e:power4.inOut;st:510;sp:1200;sR:510;"
							...
							--><rs-layer
								...
								data-type="text"
								data-rsp_ch="on"
								data-xy="x:l,l,l,c;xo:188px,188px,188px,5px;yo:590px,590px,590px,427px;"
								...
								data-frame_0_mask="u:t;x:0,0,0,0px;y:0,0,0,0px;"
								data-frame_1="x:0,0,0,0px;y:0,0,0,0px;st:900;sp:1200;sR:900;"
								data-frame_1_mask="u:t;x:0,0,0,0px;y:0,0,0,0px;"
								data-frame_999="o:0;st:w;sR:6900;"
								style="z-index:11;font-family:'Roboto';"
							>   Somos expertos en la integración de Soluciones de TI, contamos con un equipo profesional que nos permite desarrollar e implementar soluciones exitosas para tu negocio. 
							</rs-layer><!--
-->						</rs-slide>
					</rs-slides>
					<rs-static-layers><!--
			...
			<!-- END REVOLUTION SLIDER -->
				...
				<section class="elementor-section elementor-top-section elementor-element elementor-element-c8430e3 elementor-section-full_width elementor-section-stretched animated-slow elementor-section-height-default elementor-section-height-default elementor-invisible" data-id="c8430e3" data-element_type="section" data-settings="{&quot;background_background&quot;:&quot;classic&quot;,&quot;stretch_section&quot;:&quot;section-stretched&quot;,&quot;animation&quot;:&quot;fadeIn&quot;}">
						<div class="elementor-container elementor-column-gap-no">
					<div class="elementor-column elementor-col-100 elementor-top-column elementor-element elementor-element-9e6e0ed" data-id="9e6e0ed" data-element_type="column">
			<div class="elementor-widget-wrap elementor-element-populated">
								<section class="elementor-section elementor-inner-section elementor-element elementor-element-a4c0304 elementor-section-boxed elementor-section-height-default elementor-section-height-default" data-id="a4c0304" data-element_type="section" id="nosotros">
						<div class="elementor-container elementor-column-gap-default">
					<div class="elementor-column elementor-col-100 elementor-inner-column elementor-element elementor-element-076ec73" data-id="076ec73" data-element_type="column">
			<div class="elementor-widget-wrap elementor-element-populated">
								<div class="elementor-element elementor-element-e99524e elementor-widget elementor-widget-heading" data-id="e99524e" data-element_type="widget" data-widget_type="heading.default">
				<div class="elementor-widget-container">
...
.elementor-heading-title{padding:0;margin:0;line-height:1}.elementor-widget-heading .elementor-heading-title[class*=elementor-size-]>a{color:inherit;font-size:inherit;line-height:inherit}.elementor-widget-heading .elementor-heading-title.elementor-size-small{font-size:15px}.elementor-widget-heading .elementor-heading-title.elementor-size-medium{font-size:19px}.elementor-widget-heading .elementor-heading-title.elementor-size-large{font-size:29px}.elementor-widget-heading .elementor-heading-title.elementor-size-xl{font-size:39px}.elementor-widget-heading .elementor-heading-title.elementor-size-xxl{font-size:59px}</style><h2 class="elementor-heading-title elementor-size-default">¿Quiénes Somos?</h2>		</div>
				...
				<section class="elementor-section elementor-inner-section elementor-element elementor-element-f94a8c9 elementor-section-full_width elementor-section-height-default elementor-section-height-default" data-id="f94a8c9" data-element_type="section">
						<div class="elementor-container elementor-column-gap-wide">
					<div class="elementor-column elementor-col-50 elementor-inner-column elementor-element elementor-element-cc48d19" data-id="cc48d19" data-element_type="column">
			<div class="elementor-widget-wrap elementor-element-populated">
								<div class="elementor-element elementor-element-7d1d884 elementor-widget elementor-widget-text-editor" data-id="7d1d884" data-element_type="widget" data-widget_type="text-editor.default">
				<div class="elementor-widget-container">
			<style>/*! elementor - v3.8.0 - 30-10-2022 */
.elementor-widget-text-editor.elementor-drop-cap-view-stacked .elementor-drop-cap{background-color:#818a91;color:#fff}.elementor-widget-text-editor.elementor-drop-cap-view-framed .elementor-drop-cap{color:#818a91;border:3px solid;background-color:transparent}.elementor-widget-text-editor:not(.elementor-drop-cap-view-default) .elementor-drop-cap{margin-top:8px}.elementor-widget-text-editor:not(.elementor-drop-cap-view-default) .elementor-drop-cap-letter{width:1em;height:1em}.elementor-widget-text-editor .elementor-drop-cap{float:left;text-align:center;line-height:1;font-size:50px}.elementor-widget-text-editor .elementor-drop-cap-letter{display:inline-block}</style>				<p>Somos expertos en la integración de Soluciones de Tecnologías de la Información.</p><p>Contamos con un equipo de profesionales con una amplia experiencia en las tecnologías que integramos a través de nuestro modelo de negocios que nos permite desarrollar e implementar soluciones exitosas.</p><p>Nuestro equipo de expertos mantiene una constante <strong>capacitación y certificación</strong> de cada una de las tecnologías propuestas.</p>						</div>
				</div>
					</div>
		</div>
				<div class="elementor-column elementor-col-50 elementor-inner-column elementor-element elementor-element-7ec81ad" data-id="7ec81ad" data-element_type="column">
			<div class="elementor-widget-wrap elementor-element-populated">
...
.elementor-widget-image{text-align:center}.elementor-widget-image a{display:inline-block}.elementor-widget-image a img[src$=".svg"]{width:48px}.elementor-widget-image img{vertical-align:middle;display:inline-block}</style>												<img decoding="async" width="900" height="922" src="https://veriopoint.com/wp-content/uploads/2023/04/civerio-web.png" class="attachment-large size-large" alt="" srcset="https://veriopoint.com/wp-content/uploads/2023/04/civerio-web.png 900w, https://veriopoint.com/wp-content/uploads/2023/04/civerio-web-293x300.png 293w, https://veriopoint.com/wp-content/uploads/2023/04/civerio-web-768x787.png 768w" sizes="(max-width: 900px) 100vw, 900px" />															</div>
				...
				<section class="elementor-section elementor-inner-section elementor-element elementor-element-7093c41 elementor-section-boxed elementor-section-height-default elementor-section-height-default" data-id="7093c41" data-element_type="section">
						<div class="elementor-container elementor-column-gap-default">
					<div class="elementor-column elementor-col-100 elementor-inner-column elementor-element elementor-element-c756fd8" data-id="c756fd8" data-element_type="column">
			<div class="elementor-widget-wrap elementor-element-populated">
								<div class="elementor-element elementor-element-caa3470 elementor-view-default elementor-widget elementor-widget-icon" data-id="caa3470" data-element_type="widget" data-widget_type="icon.default">
				<div class="elementor-widget-container">
			...
			<i aria-hidden="true" class="far fa-star"></i>			</div>
				...
				<div class="elementor-element elementor-element-6eeb54e elementor-widget elementor-widget-text-editor" data-id="6eeb54e" data-element_type="widget" data-widget_type="text-editor.default">
				<div class="elementor-widget-container">
							<p style="text-align: center;"><strong><span style="font-size: 110%;">Misión</span></strong></p><p>Brindar la <span data-dobid="hdw">excelencia</span> y calidad en la integración de tecnologías y negocios con nuestros socios comerciales.</p>						</div>
				</div>
					</div>
		</div>
							</div>
		</section>
				<section class="elementor-section elementor-inner-section elementor-element elementor-element-0f09267 elementor-section-boxed elementor-section-height-default elementor-section-height-default" data-id="0f09267" data-element_type="section">
						<div class="elementor-container elementor-column-gap-default">
					<div class="elementor-column elementor-col-50 elementor-inner-column elementor-element elementor-element-d9bfaba" data-id="d9bfaba" data-element_type="column">
			<div class="elementor-widget-wrap elementor-element-populated">
								<div class="elementor-element elementor-element-a20f171 elementor-view-default elementor-widget elementor-widget-icon" data-id="a20f171" data-element_type="widget" data-widget_type="icon.default">
				<div class="elementor-widget-container">
					<div class="elementor-icon-wrapper">
			<div class="elementor-icon">
			<i aria-hidden="true" class="fas fa-award"></i>			</div>
				...
				<div class="elementor-element elementor-element-2674764 elementor-widget elementor-widget-text-editor" data-id="2674764" data-element_type="widget" data-widget_type="text-editor.default">
				<div class="elementor-widget-container">
							<p style="text-align: center;"><strong><span style="font-size: 110%;">Visión</span></strong></p><p>Nuestra visión tiene como principios fundamentales:</p><ul><li>Ser reconocidos por nuestros clientes como los socios preferidos a través de nuestros modelos de negocio.</li><li>Ser reconocidos por la innovación.</li><li>Ser líder en la integración de la información, satisfaciendo y superando las expectativas de nuestros socios de negocio.</li></ul>						</div>
				</div>
					</div>
		</div>
				<div class="elementor-column elementor-col-50 elementor-inner-column elementor-element elementor-element-a4e5eeb" data-id="a4e5eeb" data-element_type="column">
			<div class="elementor-widget-wrap elementor-element-populated">
								<div class="elementor-element elementor-element-a6fc166 elementor-view-default elementor-widget elementor-widget-icon" data-id="a6fc166" data-element_type="widget" data-widget_type="icon.default">
				<div class="elementor-widget-container">
					<div class="elementor-icon-wrapper">
			<div class="elementor-icon">
			<i aria-hidden="true" class="fas fa-check-double"></i>			</div>
				...
				<div class="elementor-element elementor-element-369c2e3 elementor-widget elementor-widget-text-editor" data-id="369c2e3" data-element_type="widget" data-widget_type="text-editor.default">
				<div class="elementor-widget-container">
							<p style="text-align: center;"><strong><span style="font-size: 110%;">Valores</span></strong></p><p><strong>Pasión por el Cliente.</strong></p><p>Creemos en la pasión por el cliente, dando solución y forma de trabajo en torno a las ambiciones de cada negocio. Construimos relaciones solidas a largo plazo trabajando como un socio comercial con el cliente, innovando y desarrollando nuevas soluciones en conjunto.</p><p><strong>Espiritu Emprendedor.</strong></p><p>A nuestros socios de negocio se les impulsa a crear soluciones para mejorar el conocimiento de la tecnología de la información, ya que creemos que ellos encarnan el espíritu empresarial.</p><p><strong>Innovación</strong></p><p>El concepto de innovación refleja nuestra voluntad de pensar y actuar fuera del enfoque de proyectos convencionales y para empujar los límites de las ideas.</p>						</div>
				</div>
					</div>
		</div>
							</div>
				...
				<section class="elementor-section elementor-top-section elementor-element elementor-element-c10e132 elementor-section-content-top elementor-section-full_width elementor-section-height-default elementor-section-height-default elementor-invisible" data-id="c10e132" data-element_type="section" id="soluciones" data-settings="{&quot;background_background&quot;:&quot;classic&quot;,&quot;animation&quot;:&quot;fadeInUp&quot;}">
						<div class="elementor-container elementor-column-gap-extended">
					<div class="elementor-column elementor-col-100 elementor-top-column elementor-element elementor-element-12f4cd8" data-id="12f4cd8" data-element_type="column">
			<div class="elementor-widget-wrap elementor-element-populated">
								<div class="elementor-element elementor-element-6471eae elementor-widget elementor-widget-heading" data-id="6471eae" data-element_type="widget" data-widget_type="heading.default">
				<div class="elementor-widget-container">
			<h1 class="elementor-heading-title elementor-size-default">Nuestra Tecnología</h1>		</div>
				</div>
				<section class="elementor-section elementor-inner-section elementor-element elementor-element-3da3879 elementor-section-boxed elementor-section-height-default elementor-section-height-default" data-id="3da3879" data-element_type="section">
						<div class="elementor-container elementor-column-gap-default">
					<div class="elementor-column elementor-col-100 elementor-inner-column elementor-element elementor-element-af9f712" data-id="af9f712" data-element_type="column">
			<div class="elementor-widget-wrap elementor-element-populated">
		...
		<section class="elementor-section elementor-inner-section elementor-element elementor-element-f49e57d elementor-section-boxed elementor-section-height-default elementor-section-height-default" data-id="f49e57d" data-element_type="section">
			<div class="elementor-container elementor-column-gap-default">
				...
				<section class="elementor-section elementor-top-section elementor-element elementor-element-0e4ebad elementor-section-full_width elementor-section-height-default elementor-section-height-default elementor-invisible" data-id="0e4ebad" data-element_type="section" id="servicios" data-settings="{&quot;background_background&quot;:&quot;gradient&quot;,&quot;shape_divider_top&quot;:&quot;pyramids&quot;,&quot;animation&quot;:&quot;fadeInUp&quot;}">
					<div class="elementor-shape elementor-shape-top" data-negative="false">
			<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1000 100" preserveAspectRatio="none">
	<path class="elementor-shape-fill" d="M761.9,44.1L643.1,27.2L333.8,98L0,3.8V0l1000,0v3.9"/>
</svg>		</div>
					<div class="elementor-container elementor-column-gap-no">
					<div class="elementor-column elementor-col-100 elementor-top-column elementor-element elementor-element-2b499dc" data-id="2b499dc" data-element_type="column">
			<div class="elementor-widget-wrap elementor-element-populated">
								<section class="elementor-section elementor-inner-section elementor-element elementor-element-e12b1a6 elementor-section-boxed elementor-section-height-default elementor-section-height-default" data-id="e12b1a6" data-element_type="section">
						<div class="elementor-container elementor-column-gap-default">
					<div class="elementor-column elementor-col-100 elementor-inner-column elementor-element elementor-element-cf1db6b" data-id="cf1db6b" data-element_type="column">
			<div class="elementor-widget-wrap elementor-element-populated">
								<div class="elementor-element elementor-element-1743305 elementor-widget elementor-widget-heading" data-id="1743305" data-element_type="widget" data-widget_type="heading.default">
				<div class="elementor-widget-container">
			<h2 class="elementor-heading-title elementor-size-default">Nuestros Servicios</h2>		</div>
				...
				<section class="elementor-section elementor-inner-section elementor-element elementor-element-a90a67d elementor-section-boxed elementor-section-height-default elementor-section-height-default" data-id="a90a67d" data-element_type="section">
						<div class="elementor-container elementor-column-gap-wide">
					<div class="elementor-column elementor-col-50 elementor-inner-column elementor-element elementor-element-ac48790" data-id="ac48790" data-element_type="column">
			<div class="elementor-widget-wrap elementor-element-populated">
				...
				<div class="elementor-column elementor-col-50 elementor-inner-column elementor-element elementor-element-b2e6d2e" data-id="b2e6d2e" data-element_type="column">
			<div class="elementor-widget-wrap elementor-element-populated">
			...
			<link rel="stylesheet" href="https://veriopoint.com/wp-content/plugins/elementor/assets/css/widget-icon-box.min.css">		<div class="elementor-icon-box-wrapper">
				...
				<h1 class="elementor-icon-box-title">
					<span  >
						Implementación de tecnología enfocada a la ciberseguridad.					</span>
				</h1>
							</div>
		</div>
				</div>
				</div>
				<div class="elementor-element elementor-element-81ab919 elementor-position-left elementor-view-default elementor-mobile-position-top elementor-vertical-align-top elementor-widget elementor-widget-icon-box" data-id="81ab919" data-element_type="widget" data-widget_type="icon-box.default">
				<div class="elementor-widget-container">
				...
				<h1 class="elementor-icon-box-title">
					<span  >
						Soporte 24x7 los 365 días del año.					</span>
				</h1>
							</div>
		</div>
				</div>
				</div>
				<div class="elementor-element elementor-element-8da1d61 elementor-position-left elementor-view-default elementor-mobile-position-top elementor-vertical-align-top elementor-widget elementor-widget-icon-box" data-id="8da1d61" data-element_type="widget" data-widget_type="icon-box.default">
				<div class="elementor-widget-container">
					<div class="elementor-icon-box-wrapper">
						<div class="elementor-icon-box-icon">
				<span class="elementor-icon elementor-animation-" >
				...
				<h1 class="elementor-icon-box-title">
					<span  >
						Consultoría integral en Ciberseguridad.					</span>
				</h1>
							</div>
		</div>
				</div>
				</div>
				<div class="elementor-element elementor-element-4866a5b elementor-position-left elementor-view-default elementor-mobile-position-top elementor-vertical-align-top elementor-widget elementor-widget-icon-box" data-id="4866a5b" data-element_type="widget" data-widget_type="icon-box.default">
				<div class="elementor-widget-container">
					<div class="elementor-icon-box-wrapper">
						<div class="elementor-icon-box-icon">
				<span class="elementor-icon elementor-animation-" >
				...
				<h1 class="elementor-icon-box-title">
					<span  >
						Administración de recursos Inplant.					</span>
				</h1>
							</div>
		</div>
				</div>
				</div>
				<div class="elementor-element elementor-element-0ba8159 elementor-position-left elementor-view-default elementor-mobile-position-top elementor-vertical-align-top elementor-widget elementor-widget-icon-box" data-id="0ba8159" data-element_type="widget" data-widget_type="icon-box.default">
				<div class="elementor-widget-container">
					<div class="elementor-icon-box-wrapper">
						<div class="elementor-icon-box-icon">
				<span class="elementor-icon elementor-animation-" >
				...
				<h1 class="elementor-icon-box-title">
					<span  >
						Administración de recursos Athome.					</span>
				</h1>
							</div>
		</div>
				</div>
				</div>
				<div class="elementor-element elementor-element-23e9bcf elementor-position-left elementor-view-default elementor-mobile-position-top elementor-vertical-align-top elementor-widget elementor-widget-icon-box" data-id="23e9bcf" data-element_type="widget" data-widget_type="icon-box.default">
				<div class="elementor-widget-container">
					<div class="elementor-icon-box-wrapper">
						<div class="elementor-icon-box-icon">
				<span class="elementor-icon elementor-animation-" >
				...
				<h1 class="elementor-icon-box-title">
					<span  >
						Cobertura Nacional y Centro América.					</span>
				</h1>
							</div>
		</div>
				</div>
...
</li><li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-16"><a href="#nosotros">Nosotros</a></li>
...
<link href="https://fonts.googleapis.com/css?family=Roboto:400%2C500%2C900%7CMontserrat:100&display=swap" rel="stylesheet" property="stylesheet" media="all" type="text/css" >

<script>
		if(typeof revslider_showDoubleJqueryError === "undefined") {function revslider_showDoubleJqueryError(sliderID) {console.log("You have some jquery.js library include that comes after the Slider Revolution files js inclusion.");console.log("To fix this, you can:");console.log("1. Set 'Module General Options' -> 'Advanced' -> 'jQuery & OutPut Filters' -> 'Put JS to Body' to on");console.log("2. Find the double jQuery.js inclusion and remove it");return "Double Included jQuery Library";}}
</script>
<link rel="stylesheet" property="stylesheet" id="rs-icon-set-fa-icon-css" href="{{ asset('css/font-awesome.css') }}" type="text/css" media="all" />
			<link rel="stylesheet" property="stylesheet" id="rs-icon-set-fa-icon-css" href="{{asset('css/font-awesome.css')}}" type="text/css" media="all" />
